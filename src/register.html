...
<div class="container text-start  mx-auto mt-10 p-6 bg-white rounded-lg shadow-xl max-w-xl ">
    ...
    <form class="flex flex-col justify-start" method="post" action=" ">
        <div class="mb-6 ">
            ...
            <input class="appearance-none border rounded w-2/3 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="fistname" type="text" placeholder="Enter your username" name="firstname">
    </div>
        <div class="mb-6">
            <label class="none text-gray-700 w-1/3  font-bold mb-2" for="last name">
                last name:
            </label>
            <input class="appearance-none border rounded w-2/3 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="lastname" type="text" placeholder="Enter your username" name="lastname">
        </div>
        <div class="mb-6">
        ...
        <div class="mb-6">
            ...
            <input class="appearance-none border rounded w-2/3 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="confirmpassword" type="text" placeholder="Enter your username" name="confirmpassword">
        </div>
