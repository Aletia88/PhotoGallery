...
<div class="container text-start  mx-auto mt-10 p-6 bg-white rounded-lg shadow-xl max-w-xl ">
    ...
    <form class="flex flex-col justify-start" method="post" action="conn.php">
        <div class="mb-6 ">
            <label class="none text-gray-700 w-1/3 font-bold mb-2" for="firstname">
                Fist name:
            </label>
            <input class="appearance-none border rounded w-2/3 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="fistname" type="text" placeholder="Enter your first name" name="firstname" required>
    </div>
        <div class="mb-6">
        ...
        <div class="mb-6">
            ...
            <label class="none text-gray-700 w-1/3  font-bold mb-2" for="phonenumber">
                    Phone number:
            </label>
            <input class="appearance-none border rounded w-2/3 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="email" type="tel" placeholder="Enter your phone number" name="phonenumber">
        </div>
        ...
        <div class="mb-6">
            ...
            <input class="appearance-none border rounded w-2/3 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="confirmpassword" type="password" placeholder="re-type the previous password" name="confirmpassword" required>
        </div>
