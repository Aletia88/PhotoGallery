...
<body class="bg-whtie flex  w-screen gap-48">
  ...
  <div class="flex flex-col items-center justify-center h-screen">
    ...
    <form class="w-full max-w-md p-6 rounded-lg shadow-lg bg-white" method="post" action="loginvalidator.php">
      ...
      <div class="mb-6">
        ...
        <input class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline shadow-lg" id="password" type="password" placeholder="Enter your password " name="password">
      </div>
      <div class="flex items-center justify-between mb-6">
        <label class="inline-flex items-center text-gray-700 font-bold">
          <input type="checkbox" class="form-checkbox h-4 w-4 text-yellow-600 focus:outline-none focus:shadow-outline" unchecked>
          <span class="ml-2">Remember me</span>
        </label>
        <a class="inline-block align-baseline font-bold text-sm text-yellow-600 hover:text-yellow-800" href="#">Forgot Password?</a>
      </div>
      <input type="submit" value="login" class="bg-yellow-600 hover:bg-yellow-800 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline w-full mb-4"  name="submit">
