...
<body>
    ...
    <main class="grid grid-cols-2  gap-4 ml-10">
		<section id="section1" class="border rounded-xl w-3/4 p-10 shadow-lg">
			<h2>Getting Started</h2>
			<p>If you're new to our photo gallery website, welcome! To get started, simply create an account and log in. Once you're logged in, you can start uploading your photos and creating galleries.</p>
		</section>
